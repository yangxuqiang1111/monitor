package com.yangxq.monitor.web;
...
public class JettyStarter {
    ...
    private static final String CONFIG_LOCATION_XML = "WEB-INF/mvc-dispatcher-servlet.xml";
    private static final String MAPPING_URL = "/";
    private static final String WEBAPP_DIRECTORY = "webapp";

    public static void main(String[] args) throws Exception {
        new JettyStarter().startJetty(PORT);
    }
    ...
    private static WebApplicationContext getWebApplicationContext() {
        ...
        context.setConfigLocation(CONFIG_LOCATION_XML);
