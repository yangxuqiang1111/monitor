...
public class StatisticController extends BaseController {
    ...
    public ModelAndView test(HttpServletRequest request,ModelAndView modelAndView) {
        StatisticsDataModel statisticsDataModel = statisticProvider.listByTime(875, DateUtil.getNowMinute());
        modelAndView.addObject("dates",statisticsDataModel.getDateArr());
        modelAndView.addObject("datas",statisticsDataModel.getDataArr());
